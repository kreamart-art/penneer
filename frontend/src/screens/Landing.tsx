    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(98% 37.5% at 50% 21%, rgba(3,1,10,0) 0%, rgba(3,1,10,0) 36%, rgba(3,1,10,.24) 44%, rgba(3,1,10,.52) 52%, rgba(3,1,10,.74) 60%, rgba(3,1,10,.88) 68%, rgba(3,1,10,.96) 77%, rgba(3,1,10,1) 88%, rgba(3,1,10,1) 100%)",
        }}
      />
      {[false, true].map((slow) => (
